...
class CreatePopularCardScheduler(
    ...
    fun runCreatePopularCardJob() {
        val jobParameters = JobParametersBuilder()
            .addString("createVersion", UUID.randomUUID().toString())
            .toJobParameters()
        println("aaaaaaaa:: " + jobParameters.getString("createVersion"))
    ...
    ): ItemWriter<PopularFeedCardId> {
        println("run:: newPopularCardWriter :: $createVersion")
        return JdbcBatchItemWriterBuilder<PopularFeedCardId>()
            .dataSource(dataSource)
            .sql("""
    ...
    fun deletePreviousPopularCardReader(
        ...
        requireNotNull(createVersion) { "createVersion must not be null" }
        return JdbcPagingItemReaderBuilder<PopularFeedCardId>()
